...
coords.quest_click_1 = Location(724, 1059)  -- Click the quest to play (the top most one)
coords.quest_click_2 = Location(724, 1563)  -- Click the quest to play (the 2nd top most one)
